...
<div class="flex items-center gap-1">
   ...
   class="rounded-lg border px-2 py-1 text-xs font-semibold transition {{ $lc === 'zh_TW' ? 'border-orange-400 bg-orange-50 text-orange-700' : 'border-slate-200 text-slate-500 hover:bg-slate-50' }}">ZH</a>
    <a href="{{ route('locale.switch', 'zh_CN') }}"
       class="rounded-lg border px-2 py-1 text-xs font-semibold transition {{ $lc === 'zh_CN' ? 'border-orange-400 bg-orange-50 text-orange-700' : 'border-slate-200 text-slate-500 hover:bg-slate-50' }}">CN</a>
