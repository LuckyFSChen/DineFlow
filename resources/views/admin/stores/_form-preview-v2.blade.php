...
<div class="grid gap-6 lg:grid-cols-2">
    ...
    <div class="lg:col-span-2">
        ...
        <div id="banner-preview-wrapper-v2" class="mt-4 {{ $store->banner_image ? '' : 'hidden' }}">
            <div class="relative">
                <img id="banner-preview-v2"
...
<script>
(() => {
    const dropzone = document.getElementById('banner-dropzone-v2');
    const input = document.getElementById('banner-input-v2');
    const preview = document.getElementById('banner-preview-v2');
    const wrapper = document.getElementById('banner-preview-wrapper-v2');
    const removeButton = document.getElementById('banner-remove-v2');
