...
<div class="min-h-screen bg-slate-50">
    <div class="mx-auto max-w-4xl px-6 py-10 lg:px-8">
        <div class="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold tracking-tight text-slate-900">{{ __('admin.product_edit_title') }}</h1>
                <p class="mt-2 text-slate-600">{{ __('admin.product_edit_desc', ['store' => $store->name, 'product' => $product->name]) }}</p>
            </div>
