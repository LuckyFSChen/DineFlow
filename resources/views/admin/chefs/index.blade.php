...
<div class="min-h-screen bg-slate-50">
    <div class="mx-auto max-w-6xl px-6 py-10 lg:px-8">
        ...
        >
            <x-slot name="actions">
                @if($store->is_active)
                    <a href="{{ route('admin.stores.kitchen', $store) }}" class="inline-flex items-center rounded-2xl border border-orange-300/70 bg-orange-500/20 px-4 py-3 text-sm font-semibold text-orange-100 transition hover:bg-orange-500/30">{{ __('admin.kitchen') }}</a>
                @endif
